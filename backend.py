...
def ask_question(question, context_embeddings, philosopher, open_ai_api_key, temperature=0.0):
    """
    Asks a question using the context embeddings.
    """
    
    assert open_ai_api_key is not "", "Must provide OpenAI API Key."
    openai.api_key = open_ai_api_key
    assert openai.api_key is not None, "Must provide OpenAI API Key."
